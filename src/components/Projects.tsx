          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              >
                ...
                {/* Hover Overlay */}
                <div className="absolute inset-0 bg-gradient-to-t from-[#12121a] via-transparent to-transparent opacity-0 group-hover: opacity-100 transition-opacity duration-300"></div>
              </div>
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex gap-3 pt-2">
                  <button className="flex-1 py-2 glass rounded-lg text-gray-300 hover:text-white hover:bg-white/10 transition-all duration-300 text-sm font-medium flex items-center justify-center gap-2">
                    <svg
                      className="w-4 h-4"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                  ...
                  <button className="flex-1 py-2 bg-gradient-to-r from-[#6366f1] to-[#8b5cf6] rounded-lg text-white text-sm font-medium hover:shadow-lg hover:shadow-[#6366f1]/30 transition-all duration-300 flex items-center justify-center gap-2">
                    <svg
                      className="w-4 h-4"
                      fill="none"
                      stroke="currentColor"
